...
import * as sty from "./PlasmicTestimonialsPreviousNextButton.module.css"; // plasmic-import: C5XPhXDqLaIt/css

import Icon2Icon from "./icons/PlasmicIcon__Icon2"; // plasmic-import: E7iPAloRSMSJ/icon
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <Icon2Icon
            className={classNames(defaultcss.all, sty.svg__b3QQt)}
            role={"img"}
          />
        ),
