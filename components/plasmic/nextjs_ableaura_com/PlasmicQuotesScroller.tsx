...
import * as sty from "./PlasmicQuotesScroller.module.css"; // plasmic-import: vcLlqypshqLh/css
  ...
  return (
    ...
    >
      {p.renderPlasmicSlot({
        defaultContents: (
          <Testimonials
            className={classNames("__wab_instance", sty.testimonials__peSo4)}
          />
        ),
