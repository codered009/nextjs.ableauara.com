...
import * as sty from "./PlasmicPriceTier.module.css"; // plasmic-import: MBoow2FmrUFd/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox__hfsC)}
      >
        <div className={classNames(defaultcss.all, sty.freeBox__mgoz)}>
          {p.renderPlasmicSlot({
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <Linky
              className={classNames("__wab_instance", sty.linky__deo7H)}
              style={["purpleSolid"]}
            />
          ),
