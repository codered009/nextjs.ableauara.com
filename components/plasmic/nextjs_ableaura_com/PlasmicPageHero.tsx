...
import * as sty from "./PlasmicPageHero.module.css"; // plasmic-import: vbMgnF8jjWCL/css
  ...
  return (
    ...
    >
      <p.Stack
        as={"div"}
        hasGap={true}
        className={classNames(defaultcss.all, sty.freeBox___1MRzP)}
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <GraphicIcon
              className={classNames("__wab_instance", sty.graphicIcon__z8WfO)}
              colors={"gray" as const}
            >
              <Icon12Icon
                className={classNames(defaultcss.all, sty.svg__pNz8Q)}
                role={"img"}
              />
            </GraphicIcon>
          ),
        ...
        <div className={classNames(defaultcss.all, sty.freeBox__xnWtt)}>
          {p.renderPlasmicSlot({
        ...
        <div className={classNames(defaultcss.all, sty.freeBox__bM09S)}>
          {p.renderPlasmicSlot({
