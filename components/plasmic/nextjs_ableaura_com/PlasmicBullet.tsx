...
import * as sty from "./PlasmicBullet.module.css"; // plasmic-import: IexO7MBZURmx/css
...
export type PlasmicBullet__VariantsArgs = {
  bulletedList?: SingleBooleanChoiceArg<"bulletedList">;
};
    ...
    >
      <div
        ...
        className={classNames(defaultcss.all, defaultcss.__wab_text, sty.text, {
          [sty.text__bulletedList]: hasVariant(
            variants,
            "bulletedList",
            "bulletedList"
          )
      ...
      >
        {hasVariant(variants, "bulletedList", "bulletedList") ? "∙" : "✓"}
      </div>
